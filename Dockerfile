...
WORKDIR /workspaces/agent-development-kit-(adk)-masterclass-with-brandon/
...
# Expose the app.
ENTRYPOINT ["/workspaces/agent-development-kit-(adk)-masterclass-with-brandon/.venv/bin/poe"]
CMD ["serve"]
